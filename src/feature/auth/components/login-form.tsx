  ...
  return (
    <div className="space-y-8">
        ...
        <form.Field
          ...
          validators={{
            onChange: ({ value }) => {
              ...
              if (!validatePhone(value)) return "لطفاً شماره موبایل معتبر وارد کنید"
              return undefined
            },
            onSubmit: ({ value }) => {
              if (!validatePhone(value)) return "لطفاً شماره موبایل معتبر وارد کنید"
      ...
      <p className="text-center text-sm text-muted-foreground">
        با ورود به سایت، 
        <a href="/terms" className="text-primary hover:underline mx-1">شرایط استفاده</a>
        و
        <a href="/privacy" className="text-primary hover:underline mx-1">حریم خصوصی</a>
        را می‌پذیرید.
      </p>
    </div>
  )
